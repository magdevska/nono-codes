...
uint64_t optimal_values[5][22] = {
        ...
        {9,  27,  81,  251,  829,   2753,  9805,   34921,   124373,  446496, 1619604, 5941181, 21917583},
        {18, 64,  256, 1024, 4181,  17711, 76816,  341792,  1520800, 6817031, 31438129},
        {32, 128, 625, 3125, 15625, 79244, 411481, 2188243, 11755857, 63281718}
};
    ...
    if (current_level == 0) {
        for (int i = 1; i <= q / 2; i++) {
            ...
            if (q == 2) {
                ...
                print_optimal_solutions(left, right, n, q, 2, conditions, parameters);
            } else {
